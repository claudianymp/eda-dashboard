...
O cancer do pulmão é uma das principais causas de mortalidade oncológica global. Este projeto visa fornecer modelos diagnósticos precisos através da integração de dados multidimensionais: **Radiômica (imagem), Clínica e Genômica**.
...
* `cancer_stage`: Estágio clínico (I a IV).
...
* **Validação de Grupos**: Verificação de como as variáveis radiômicas e genômicas se agrupam naturalmente sem a influência dos rótulos pré-existentes.
